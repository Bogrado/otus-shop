...
- Создание удаленных favorites и cart при регистрации пользователей
- Корзина на сервере для каждого пользователя
...
14. [ ] Сохранять адрес юзеру и либо автозаполнять при монтировании чекаута либо добавить что-нибудь по типа сохраненных
    адресов
15. [ ] Добавить обработку ошибок для асинхронных запросов, база для этого уже есть,
    осталось их выводить не только в консоль, но и пользователю на страницу